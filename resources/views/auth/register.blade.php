                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" id="type_document" name="type_document">
                                        <option value="DNI" default>DNI</option>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="number_document" type="text"
                                           class="form-control @error('number_document') is-invalid @enderror"
                                           name="number_document" value="{{ old('number_document') }}" required
                                           autocomplete="number_document" autofocus>
